...
$canProcessImages = match (env('IMAGE_DRIVER', 'gd')) {
...
return [
     ...
     */
    'generate_thumbnails_for_temporary_uploads' => env(
        'MEDIA_GENERATE_TEMPORARY_UPLOAD_THUMBNAILS',
        $canProcessImages,
    ),
